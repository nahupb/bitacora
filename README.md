...
- **Body:** está compuesto por una tabla con buscador que muestra todos los tickets almacenados en la BBDD. Al hacer clic sobre alguna de las columnas, la tabla filtrará los resultados por el valor más bajo. Al hacer doble clic, filtrará por el valor más alto. </br> En la columna Acción tenemos tres botones para editar, resolver o eliminar una entrada. ![image](https://github.com/nahupb/bitacora/assets/141838996/4e4f229f-06fd-4ad4-84cc-f8ec73fc1c58)
