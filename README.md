...
- **Body:** está compuesto por una tabla con buscador que muestra todas las entradas almacenadas en la BBDD. Si hacemos clic sobre alguna de las columnas, la tabla filtrará los resultados por el valor más bajo. Al hacer doble clic, filtrará por el valor más alto. </br></br>
En la columna Acción tenemos tres botones para editar, resolver o eliminar una entrada. ![image](https://github.com/nahupb/bitacora/assets/141838996/4e4f229f-06fd-4ad4-84cc-f8ec73fc1c58)
...
al hacer clic saltará un banner solicitando confirmación. En la BBDD, el valor "NO" se modificará por "SI" en la columna RESUELTO, por lo que la entrada se eliminará de Tratamiento Inditex y la podremos visualizar en el apartado Resueltos. ![image](https://github.com/nahupb/bitacora/assets/141838996/f9e9c9e0-f3a4-43c1-a831-2237893c4674)
...
Al pulsar el botón, saltará un banner solicitando confirmación. En la BBDD, el valor "SI" se modificará por "NO" en la columna RESUELTO, por lo que al entrada se eliminará de Resueltos y la podremos visualizar en el apartado Tratamiento Inditex.
