...
- **Body:** está compuesto por una tabla con buscador que muestra todos los tickets almacenados en la BBDD. Al hacer clic sobre alguna de las columnas, la tabla filtrará los resultados por el valor más bajo. Al hacer doble clic, filtrará por el valor más alto.
