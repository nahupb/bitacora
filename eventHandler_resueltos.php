...
if($jsonObj->request_type == 'addEditUser'){
    ...
    if(!empty($user_data) && empty($err)){
        if(!empty($ticket)){
            ...
            llamada_guardias='".$llamada_guardias."', descripcion='".$descripcion."', grupo_escalado='".$grupo_escalado."'
            where ticket='".$ticket."'";
            ...
            $sql="insert into tratamiento(fecha_creacion,ticket_proveedor,llamada_guardias,descripcion,ticket_remedy,grupo_escalado)
            values('".$fecha_creacion."','".$ticket_proveedor."','".$llamada_guardias."','".$descripcion."','".$ticket_remedy."','".$grupo_escalado."')";
...
//Solve user
    ...
    $ticket = $jsonObj->user_ticket;
    $sql="update tratamiento set resuelto='NO'
    where ticket='".$ticket."'";
